...
//	Если ДополнительныеПараметры.ОписаниеКоманды.Идентификатор = "Документ._ЗаявкаНаДоставку" Тогда
//		Если ДополнительныеПараметры.Форма.Открыта() Тогда
//			ДополнительныеПараметры.Форма.Закрыть();
//		КонецЕсли;		// ДополнительныеПараметры.Форма.Открыта() 		
////		УникальныйИдентификаторФорма = ДополнительныеПараметры.Форма.УникальныйИдентификатор;
////		Документ.ЗаказКлиента.ПолучитьФормуНовогоДокумента(,,ДополнительныеПараметры.Форма.УникальныйИдентификатор)
//	КонецЕсли;		// ДополнительныеПараметры.ОписаниеКоманды.Идентификатор = "Документ._ЗаявкаНаДоставку" 		
//	//***********************************************************************
...
Процедура ПроверитьПроведенностьДокументовПроведениеДокументов(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	Если ТипЗнч(ДополнительныеПараметры.Форма) = Тип("УправляемаяФорма")
		и ДополнительныеПараметры.Форма.Параметры.Свойство("Ключ") Тогда
		Попытка
...
Процедура СообщитьКомандаФормаНедоступна(Объект)
	ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Создание на основании %1 не выполнено: выбранная команда недоступна.'"), Объект);
