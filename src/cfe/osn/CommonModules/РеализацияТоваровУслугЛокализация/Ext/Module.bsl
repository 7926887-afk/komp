...
Функция Кт_ПолучитьДанныеДляПечатнойФормыУПД(ПараметрыПечати, МассивОбъектов)
	...
	|" + Кт_ОбщегоНазначенияСервер.ТекстЗапросаНаименованиеПоНоменклатуреПартнера("ТаблицаДокумента") + " КАК НоменклатураНаименование,
	|	ВЫБОР
