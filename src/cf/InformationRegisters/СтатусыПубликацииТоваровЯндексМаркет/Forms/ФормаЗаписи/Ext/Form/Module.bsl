...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Запись.Статус = Перечисления.СтатусыВыгрузкиТоваровЯндексМаркет.ПустаяСсылка()
			...
			Или Запись.Статус = Перечисления.СтатусыВыгрузкиТоваровЯндексМаркет.РекомендацияНеНайдена Тогда
		Элементы.ИдентификаторПредложения.ТолькоПросмотр = Ложь;
	Иначе 
		Элементы.ИдентификаторПредложения.ТолькоПросмотр = Истина;
	КонецЕсли;
