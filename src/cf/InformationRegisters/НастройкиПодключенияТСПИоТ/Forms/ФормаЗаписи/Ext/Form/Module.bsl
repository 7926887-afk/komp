...
Процедура ЗащищенноеСоединениеПриИзменении(Элемент)
	...
	ПредустановкаПортаПриИзмененииЗащищенногоСоединения();
	ПроверитьНастройкиПодключения();
...
&НаКлиенте
Процедура ПредустановкаПортаПриИзмененииЗащищенногоСоединения()
	
	Если Запись.ЗащищенноеСоединение Тогда
		Запись.Порт = 50402;
	Иначе
		Запись.Порт = 50401;
	КонецЕсли;
