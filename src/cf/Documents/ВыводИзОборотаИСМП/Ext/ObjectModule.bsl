...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Операция <> Перечисления.ВидыОперацийИСМП.ВыводИзОборотаЭкспортВСтраныЕАЭС
		И Не ДоступнаПередачаУведомленияОбЭкспорте Тогда
	...
	КонецЕсли;
	ИспользованиеАдреса       = ИнтеграцияИСМПСлужебныйКлиентСервер.ИспользованиеАдресаПриВыводеИзОборота(Операция,ВидПродукции,, ОбъемноСортовойУчет, ЭтоИндивидуальныйПредприниматель);
	ИспользованиеАдресаВсегда = ИнтеграцияИСМПСлужебныйКлиентСервер.ИспользованиеАдресаПриВыводеИзОборота(Операция, ВидПродукции, Истина, ОбъемноСортовойУчет, ЭтоИндивидуальныйПредприниматель);
	...
	Если Не ИнтеграцияИСМПСлужебныйКлиентСервер.ИспользованиеКонтрагентаПриВыводеИзОборота(Операция, Истина, ОбъемноСортовойУчет)
		И Не ДоступнаПередачаУведомленияОбЭкспорте Тогда
