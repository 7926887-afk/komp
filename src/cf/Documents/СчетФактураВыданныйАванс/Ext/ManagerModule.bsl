...
Функция АвансыПоПлатежномуДокументу(ПлатежныйДокумент, Организация) Экспорт
	...
	|	ДанныеСчетаФактурыАванс.Дата КАК ДатаСчетаФактурыНаАванс,
	|	ДанныеСчетаФактурыАванс.Номер КАК НомерСчетаФактурыНаАванс,
	|	ДанныеИсправленияСчетаФактурыАванс.Дата КАК ДатаИсправленияСчетаФактурыНаАванс,
	|	СчетаФактурыАванс.НомерИсправления КАК НомерИсправленияСчетаФактурыНаАванс
	|ИЗ
	...
	|	
	|		ЛЕВОЕ СОЕДИНЕНИЕ
	|			РегистрСведений.ДанныеПервичныхДокументов КАК ДанныеСчетаФактурыАванс
	|		ПО
	|			СчетаФактурыАванс.ОрганизацияАванса = ДанныеСчетаФактурыАванс.Организация
	|			И СчетаФактурыАванс.СчетФактураАванс = ДанныеСчетаФактурыАванс.Документ
	|	
	|		ЛЕВОЕ СОЕДИНЕНИЕ
	|			РегистрСведений.ДанныеПервичныхДокументов КАК ДанныеИсправленияСчетаФактурыАванс
	|		ПО
	|			СчетаФактурыАванс.ОрганизацияАванса = ДанныеИсправленияСчетаФактурыАванс.Организация
	|			И СчетаФактурыАванс.ИсправлениеСчетаФактурыАванс = ДанныеИсправленияСчетаФактурыАванс.Документ";
...
Функция ТаблицаДанныхДокументов(МенеджерВременныхТаблиц)
	...
	Запрос.УстановитьПараметр("СтавкаНДС22_122",        ПредопределенноеЗначение("Справочник.СтавкиНДС.БезНДС"));
	Запрос.УстановитьПараметр("ДатаПереходаНаСтавку22", Дата(2026,1,1));
