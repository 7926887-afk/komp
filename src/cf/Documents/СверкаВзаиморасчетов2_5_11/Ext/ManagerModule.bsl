...
Функция ТекстЗапросаДанныеДокумента(НастройкиПечати)
	...
	|	ДеталиРасчетов.ТоварыВПути КАК ТоварыВПути,
	|
	...
	|			ИЛИ ДеталиРасчетов.ТоварыВПути)
...
Функция ПредставленияДокументов() Экспорт
	...
	ВидыДокументовКонтрагента.Вставить("Бронирование",                          НСтр("ru='Электронный билет'"));
