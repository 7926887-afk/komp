...
Процедура ДополнитьТаблицуПродажПоИнтеркампани(ТаблицаПродаж, ПараметрыРасчета)
	...
	|		И (НЕ ОтчетПоКомиссииМеждуОрганизациями.Покупатель.ЮрФизЛицо В (ЗНАЧЕНИЕ(Перечисление.ЮрФизЛицо.ЮрЛицо), ЗНАЧЕНИЕ(Перечисление.ЮрФизЛицо.ИндивидуальныйПредприниматель))
