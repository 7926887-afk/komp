...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	|	КОНЕЦ,
	|	ВЫБОР
	|		КОГДА ИдентификаторыОбъектовМетаданных.ПолноеИмя = ""Документ.ТранспортнаяНакладная""
	...
	|	ТранспортнаяНакладная.Грузополучатель,
	|	СостоянияОригиналовПервичныхДокументов.ФормаИзвне,
	|	NULL,
	|	NULL,
	|	ТранспортнаяНакладная.Грузополучатель.ИНН,
	|	СостоянияОригиналовПервичныхДокументов.Состояние,
	|	0,
	|	ВЫБОР
	...
	|		ПО (СостоянияОригиналовПервичныхДокументов.Владелец = ТранспортнаяНакладная.Ссылка),
