...
Процедура ОбработатьШтрихкоды(ДанныеШтрихкодов)
	...
	КонецЕсли;
	ПакетнаяОбработкаТабличнойЧастиКлиентСерверЛокализация.ДополнитьСтруктуруДействийПриИзмененииЭлемента(ЭтотОбъект, "НоменклатураИзменение", СтруктураДействийСИзмененнымиСтроками);
	...
	ПакетнаяОбработкаТабличнойЧастиКлиентСерверЛокализация.ДополнитьСтруктуруДействийПриИзмененииЭлемента(ЭтотОбъект, "ОбработатьШтрихкоды", СтруктураДействий);
	СтруктураДействий.ШтрихкодыВТЧ                           = Истина;
	
	Если Не ВсеТипыНоменклатуры Тогда
		ОпределитьУсловияТиповНоменклатурОбработкиШтрихкодовНаКлиенте(СтруктураДействий);
	КонецЕсли;
...
&НаКлиенте
Процедура ОпределитьУсловияТиповНоменклатурОбработкиШтрихкодовНаКлиенте(СтруктураДействий)
	
	Если ТипыНоменклатуры.НайтиПоЗначению(ПредопределенноеЗначение("Перечисление.ТипыНоменклатуры.Товар")) <> Неопределено Тогда
		ЕстьРаботы = ТипыНоменклатуры.НайтиПоЗначению(ПредопределенноеЗначение("Перечисление.ТипыНоменклатуры.Работа")) <> Неопределено;
		ЕстьУслуги = ТипыНоменклатуры.НайтиПоЗначению(ПредопределенноеЗначение("Перечисление.ТипыНоменклатуры.Услуга")) <> Неопределено;
	...
	Иначе
		Если ТипыНоменклатуры.НайтиПоЗначению(ПредопределенноеЗначение("Перечисление.ТипыНоменклатуры.Услуга")) <> Неопределено Тогда
			СтруктураДействий.ТолькоУслуги = Истина;
		ИначеЕсли ТипыНоменклатуры.НайтиПоЗначению(ПредопределенноеЗначение("Перечисление.ТипыНоменклатуры.Работа")) <> Неопределено Тогда
			СтруктураДействий.ТолькоРаботы = Истина;
		ИначеЕсли ТипыНоменклатуры.НайтиПоЗначению(ПредопределенноеЗначение("Перечисление.ТипыНоменклатуры.МногооборотнаяТара")) <> Неопределено Тогда
...
Процедура ОпределитьУсловияТиповНоменклатурОбработкиШтрихкодовНаСервере(СтруктураДействий, ТипыНоменклатуры)
	
	Если ТипыНоменклатуры.НайтиПоЗначению(Перечисления.ТипыНоменклатуры.Товар) <> Неопределено Тогда
		ЕстьРаботы = ТипыНоменклатуры.НайтиПоЗначению(Перечисления.ТипыНоменклатуры.Работа) <> Неопределено;
		ЕстьУслуги = ТипыНоменклатуры.НайтиПоЗначению(Перечисления.ТипыНоменклатуры.Услуга) <> Неопределено;
		
		СтруктураДействий.ТолькоТоварыИРабота = ЕстьРаботы И Не ЕстьУслуги;
		СтруктураДействий.ТолькоТоварыИУслуги = Не ЕстьРаботы И ЕстьУслуги;
		СтруктураДействий.ТолькоТовары        = Не ЕстьРаботы И Не ЕстьУслуги;
	Иначе
		Если ТипыНоменклатуры.НайтиПоЗначению(Перечисления.ТипыНоменклатуры.Услуга) <> Неопределено Тогда
			СтруктураДействий.ТолькоУслуги = Истина;
		ИначеЕсли ТипыНоменклатуры.НайтиПоЗначению(Перечисления.ТипыНоменклатуры.Работа) <> Неопределено Тогда
			СтруктураДействий.ТолькоРаботы = Истина;
		ИначеЕсли ТипыНоменклатуры.НайтиПоЗначению(Перечисления.ТипыНоменклатуры.МногооборотнаяТара) <> Неопределено Тогда
			СтруктураДействий.ТолькоТара   = Истина;
		КонецЕсли;
	КонецЕсли;
...
Процедура ПослеОбработкиШтрихкодов(ДополнительныеПараметры)
	...
	Если РезультатОбработкиШтрихкода.ТребуетсяОбработкаШтрихкода Тогда
		...
		ПакетнаяОбработкаТабличнойЧастиКлиентСерверЛокализация.ДополнитьСтруктуруДействийПриИзмененииЭлемента(ЭтотОбъект, "ОбработатьШтрихкоды", ДанныеДляОбработки);
		
		Если Не ВсеТипыНоменклатуры Тогда
			ОпределитьУсловияТиповНоменклатурОбработкиШтрихкодовНаСервере(ДанныеДляОбработки, ТипыНоменклатуры);
		КонецЕсли;
