...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заменяет аналитики активов/пассивов с перечисления ""типы налогов"" справочник ""виды налогов и взносов"".
		|Устанавливает время записей для документов ""Бронирование"".'");
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Для Каждого ТекущиеДанные Из ОбновляемыеДанные Цикл
		...
		Попытка
			...
			Если ТипЗнч(ТекущиеДанные.Регистратор) = Тип("ДокументСсылка.Бронирование") Тогда
				ДатаДокумента = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ТекущиеДанные.Регистратор, "Дата");
			КонецЕсли;
			#КонецОбласти
