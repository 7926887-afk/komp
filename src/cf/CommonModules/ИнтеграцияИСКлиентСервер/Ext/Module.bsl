...
Функция ДоступенСпособВводаВОборотПеремаркировка(ВидПродукции) Экспорт
	...
	Если ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПарфюмерныеИКосметическиеСредстваИБытоваяХимия")
		...
		Возврат Ложь;
	Иначе
		Возврат ВидПродукцииПодлежитПеремаркировке(ВидПродукции);
	КонецЕсли;
...
Функция ВидПродукцииПодлежитПеремаркировке(ВидПродукции) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств") Тогда
		Возврат АвтозапчастиИКомплектующиеТранспортныхСредствПодлежитПеремаркировке();
...
Функция АвтозапчастиИКомплектующиеТранспортныхСредствПодлежитПеремаркировке()
	Возврат Ложь;
КонецФункции
