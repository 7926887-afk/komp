...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если Форма.ИмяФормы = "Документ.ЧекККМ.Форма.ФормаДокументаРМК" Тогда
		Форма.ОпределятьПринадлежностьТовараИСтавкуНДСПриПодборе
			= ПолучитьФункциональнуюОпцию("ОпределятьПринадлежностьТовараИСтавкуНДСПриПодборе");
		Форма.ИспользоватьКомиссиюПриЗакупках = ПолучитьФункциональнуюОпцию("ИспользоватьКомиссиюПриЗакупках");
	КонецЕсли;
...
Процедура ПриЧтенииНаСервере(Форма, ТекущийОбъект, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если Форма.ИмяФормы = "Документ.ЧекККМ.Форма.ФормаДокументаРМК" Тогда
		...
		РозничныеПродажиЛокализация.ОбработатьРазрешенияНаПродажуТоваров(Форма);
	КонецЕсли;
...
Процедура ПриИзмененииЭлемента(Форма, Элемент, ДополнительныеПараметры) Экспорт
	...
	Если Форма.ИмяФормы = "Справочник.КассыККМ.Форма.ФормаЭлемента" 
		И Элемент = "ПротоколОбменаНСПК" Тогда
		РозничныеПродажиЛокализация.КассаККМНастроитьВидимостьЭлементовОплатыЭСФСС(Форма);
	КонецЕсли;
	//-- Локализация
	Возврат;
