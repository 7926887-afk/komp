...
Функция ОпределитьПараметрыЗапросаОбъекта(ЭлементДанных, ТипЗначенияОбъекта = Неопределено, ФормироватьИерархию = Истина) Экспорт
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("РегистрНакопленияЗапись.РаспоряженияНаОтгрузку") 
		Или ТипЗначенияОбъекта = Тип("РегистрСведенийЗапись.РаспоряженияНаОтгрузкуКВыполнению") Тогда
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("РегистрСведенийЗапись.ИдентификаторыОперацийСБПb2b") Тогда
		
		ЗначенияФильтра_РегистрыСведений_ИдентификаторыОперацийСБПb2b(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
...
Процедура ЗначенияФильтра_КорректировкаРеализации(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	...
	Если КомиссионнаяТорговляСервер.РеализацияЧерезКомиссионера(ХозяйственнаяОперацияОснования) Тогда
...
Процедура ЗначенияФильтра_РеализацияТоваровИУслуг(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	...
	Если КомиссионнаяТорговляСервер.РеализацияЧерезКомиссионера(Объект.ХозяйственнаяОперация) Тогда
...
Процедура ЗначенияФильтра_РегистрыСведений_ИдентификаторыОперацийСБПb2b(Объект, ПараметрыЗапроса, ФормироватьИерархию)
