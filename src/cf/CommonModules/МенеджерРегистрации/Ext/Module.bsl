// Регистрация Правила регистрации для конфигурации ERP 2.5.22 от 11.11.2025 10:50:39
...
Функция ПараметрыРегистрации() Экспорт
	...
	Наименование = НСтр("ru = 'Правила регистрации для конфигурации ERP 2.5.22'");
	Результат.Вставить("Наименование", Наименование);
	Результат.Вставить("ДатаВремяСоздания", Дата(2025,11,11,10,50,0));
	...
	Результат.Вставить("ВерсияКонфигурации", "2.5.22.100");
