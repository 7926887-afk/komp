...
Функция ПричинаСписанияКодаМаркировки(Знач ЗначениеПоиска) Экспорт
	...
	Если ЗначениеПоиска = "DEFECT"
		Или ЗначениеПоиска = "KM_SPOILED" Тогда
		Результат = Перечисления.ПричиныСписанияКодовМаркировкиИСМП.Испорчен;
	ИначеЕсли ЗначениеПоиска = "DAMAGE_LOSS"
		Или ЗначениеПоиска = "KM_LOST" Тогда
		Результат = Перечисления.ПричиныСписанияКодовМаркировкиИСМП.Утерян;
	ИначеЕсли ЗначениеПоиска = "DESTRUCTION"
		Или ЗначениеПоиска = "KM_DESTROYED" Тогда
