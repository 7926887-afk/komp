...
// Устарела. Следует использовать ИнтернетПоддержкаПользователейКлиент.ОткрытьСтраницуИнтегрированногоСайта.
...
// Выполняет октрытие URL для передачи сообщения пользователю посредством мессенджеров.
//
// Параметры:
//  ТекстСообщения - Строка - текст сообщения для пользователя.
//  СсылкаДляПередачи - Строка - URL для пользователя.
