...
//      где Ключ - имя реквизита, а Значение - его новое значение.
//
Функция ЗаполнитьПодчиненныеРеквизитыОбъекта(Объект, КлючевойРеквизит, ОписаниеЗаполняемыхРеквизитов = Неопределено, ПроверятьНастройку = Ложь) Экспорт
...
Процедура ЗначениеРеквизитаПоСтатистике(ОписаниеРеквизитовОбъекта, ЗаполняемыйРеквизит)
	...
	Если (ТипЗнч(ЗаполняемыйРеквизит.СтароеЗначение) = Тип("СправочникСсылка.СтруктураПредприятия") 
		ИЛИ ТипЗнч(ЗаполняемыйРеквизит.СтароеЗначение) = Тип("СправочникСсылка.Организации"))
		И ЗначениеЗаполнено(ЗаполняемыйРеквизит.НовоеЗначение)
		И ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ЗаполняемыйРеквизит.НовоеЗначение, "Статус") = Перечисления.СтатусыОрганизацийПодразделений.НеДействует Тогда
		ЗаполняемыйРеквизит.НовоеЗначение = Неопределено;
	ИначеЕсли (ТипЗнч(ЗаполняемыйРеквизит.СтароеЗначение) = Тип("СправочникСсылка.БанковскиеСчетаКонтрагентов") 
		ИЛИ ТипЗнч(ЗаполняемыйРеквизит.СтароеЗначение) = Тип("СправочникСсылка.БанковскиеСчетаОрганизаций"))
		И ЗначениеЗаполнено(ЗаполняемыйРеквизит.НовоеЗначение)
		И ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ЗаполняемыйРеквизит.НовоеЗначение, "Закрыт") Тогда
		ЗаполняемыйРеквизит.НовоеЗначение = Неопределено;
	КонецЕсли;
КонецПроцедуры
