...
// В событии ПриИзменении табличной части заказа определяет, что изменились даты отгрузки 
// и необходим вызов ВзаиморасчетыСервер.ФормаПриИзмененииРеквизитов.
// 
// Параметры:
// 	Форма - ФормаКлиентскогоПриложения - Форма документа/справочника.
// 
...
Функция ТабличнаяЧастьПриИзмененииЕстьИзменениеДатОтгрузок(Форма) Экспорт
...
// Кеширует в параметрах механизма текущие даты отгрузки заказа
// 
// Параметры:
// 	Форма - ФормаКлиентскогоПриложения - Форма документа/справочника.
Процедура ТабличнаяЧастьПередУдалением(Форма) Экспорт
	ДополненныеПараметрыМеханизма = ОбщегоНазначенияУТКлиентСервер.ПолучитьДанныеМеханизмаИзКэшаФормы(Форма, "Взаиморасчеты");
	Для Каждого СтруктураПараметров Из ДополненныеПараметрыМеханизма.МассивПараметров Цикл
...
// Параметры:
// 	Форма - ФормаКлиентскогоПриложения - Форма документа/справочника.
Процедура ТабличнаяЧастьПриНачалеРедактирования(Форма) Экспорт
	ДополненныеПараметрыМеханизма = ОбщегоНазначенияУТКлиентСервер.ПолучитьДанныеМеханизмаИзКэшаФормы(Форма, "Взаиморасчеты");
	Для Каждого СтруктураПараметров Из ДополненныеПараметрыМеханизма.МассивПараметров Цикл
		СтруктураПараметров.ДатыОтгрузки = ВзаиморасчетыКлиентСервер.МассивДатОтгрузок(Форма, СтруктураПараметров);
	КонецЦикла;
