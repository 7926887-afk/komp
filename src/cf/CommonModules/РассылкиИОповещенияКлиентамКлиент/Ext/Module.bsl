...
Процедура ПереместитьВложениеВУдаленные(Форма) Экспорт
	...
	ЭлементФормыВложения = Форма.Элементы.Вложения; // ТаблицаФормы
	Вложения             = Форма.Вложения; // ДанныеФормыКоллекция
	УдаленныеВложения = Форма.УдаленныеВложения; // СписокЗначений - 
	ТекущиеДанные = ЭлементФормыВложения.ТекущиеДанные; // ДанныеФормыЭлементКоллекции 
