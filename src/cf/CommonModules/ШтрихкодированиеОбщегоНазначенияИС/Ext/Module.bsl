...
Процедура ЗаполнитьСведенияПоШтрихкодамEANСУчетомВерсии(ДанныеПоШтрихкодам, ПараметрыСканирования, ДанныеКодовМаркировки = Неопределено) Экспорт
	...
	Для Каждого СтрокаДанных Из ДанныеКодовМаркировки Цикл
		...
		Для Каждого СтрокаИнформации Из НайденныеШтрихкодыEAN Цикл
			...
			Если ТребуетсяСопоставление Тогда
				ДанныеУточнения = Новый Структура("Номенклатура, Характеристика, Серия, Упаковка, ПредставлениеНоменклатуры, ВидПродукции");
...
Функция ТребуетсяОткрытьФормуВводаКодаМаркировки(СтрокаДанных, ПараметрыСканирования, КешНаличияСвойств = Неопределено) Экспорт
	...
	СохраненОтказОтВводаКодаМаркировки = ПараметрыСканирования.ДанныеВыбораПоМаркируемойПродукции <> Неопределено
		...
		И СтрокаДанных.ЭтоШтрихкодНоменклатуры;
