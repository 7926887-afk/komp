...
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаРазблокироватьБонусыКлиентаНовый(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода) Экспорт
	
	ПараметрыЗапроса = ПараметрыЗапросаКСерверу();
	ПараметрыЗапроса.ТипЗапроса = "POST";
	ПараметрыЗапроса.Ресурс = "unlockclientbonusesnew";
...
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаСписатьБонусыКлиентаНовый(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода) Экспорт
	
	ПараметрыЗапроса = ПараметрыЗапросаКСерверу();
	ПараметрыЗапроса.ТипЗапроса = "POST";
	ПараметрыЗапроса.Ресурс = "writeoffclientbonusesnew";
...
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаРазблокироватьПодарочныйСертификатНовый(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода) Экспорт
	
	ПараметрыЗапроса = ПараметрыЗапросаКСерверу();
	ПараметрыЗапроса.ТипЗапроса = "POST";
	ПараметрыЗапроса.Ресурс = "unlockgiftcardnew";
...
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаРазблокироватьПромокодНовый(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода) Экспорт
	
	ПараметрыЗапроса = ПараметрыЗапросаКСерверу();
	ПараметрыЗапроса.ТипЗапроса = "POST";
	ПараметрыЗапроса.Ресурс = "unlockpromocodenew";
...
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаСписатьПодарочныйСертификатНовый(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода) Экспорт
	
	ПараметрыЗапроса = ПараметрыЗапросаКСерверу();
	ПараметрыЗапроса.ТипЗапроса = "POST";
	ПараметрыЗапроса.Ресурс = "writeoffgiftcardnew";
