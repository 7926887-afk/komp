	...
	Для Каждого СтрокаДанных Из ДанныеПоШтрихкодам.ДанныеКодовМаркировки Цикл
		...
		Если ПравилаПроверкиНаОшибки.Свойство("КонтрольСтатусов")
			...
			Если ПродажаРазрешенаВОтсутствиеОтветаГИСМТ
				Или (СтрокаДанных.ПродажаПоДаннымОффлайнРежима И Не КодЗаблокированОГВ)
		...
		Если ПравилаПроверкиНаОшибки.Свойство("КонтрольРазрешительныхДокументовИСМП")
			И ОбщегоНазначенияИСМППовтИсп.ДействуетКонтрольРазрешительныхДокументов(СтрокаДанных.ВидПродукции, ПараметрыСканирования.ДатаДокумента) Тогда
